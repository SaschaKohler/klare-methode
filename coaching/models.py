...
class UserProfile(models.Model):
    ...
    coaching_focus = models.CharField(
        max_length=100,
        blank=True,
        help_text="Main area of personal development focus"
    )
...
class VisionBoard(models.Model):
    ...
    elements = models.JSONField(
        default=list,
        help_text="List of board elements with positions and content"
    )
...
class WheelAssessment(models.Model):
    ...
    title = models.CharField(max_length=200, default="Life Assessment", help_text="Name for this assessment")
